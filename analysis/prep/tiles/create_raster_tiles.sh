...
pmtiles convert tiles/midwest_blueprint.mbtiles tiles/midwest_blueprint.pmtiles
...
pmtiles convert tiles/midwest_pixel_layers_0.mbtiles tiles/midwest_pixel_layers_0.pmtiles
...
pmtiles convert tiles/midwest_pixel_layers_1.mbtiles tiles/midwest_pixel_layers_1.pmtiles
...
pmtiles convert tiles/midwest_pixel_layers_2.mbtiles tiles/midwest_pixel_layers_2.pmtiles
...
pmtiles convert tiles/midwest_pixel_layers_3.mbtiles tiles/midwest_pixel_layers_3.pmtiles
...
pmtiles convert tiles/midwest_pixel_layers_4.mbtiles tiles/midwest_pixel_layers_4.pmtiles
